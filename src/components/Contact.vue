  ...
  <section id="contact" class="py-24 md:py-32 relative overflow-hidden">
    ...
    <div class="max-w-4xl mx-auto px-6 text-center relative">
      ...
      <div class="flex flex-col sm:flex-row gap-4 justify-center mt-12">
        <a :href="`mailto:${email}`"
          class="group flex items-center gap-4 px-8 py-5 rounded-2xl glass-iridescent hover-lift reveal-up delay-1"
          ref="card1Ref">
        ...
        <a :href="github" target="_blank" rel="noopener noreferrer"
          class="group flex items-center gap-4 px-8 py-5 rounded-2xl glass-iridescent hover-lift reveal-up delay-2"
          ref="card2Ref">
